...
alias df='dfi(){ df $@|grep -vE "android|product|overlay|tmpfs"; };dfi'
...
alias pyvenv='source ~/venv/bin/activate; cd ~/demo/base/python3'
...
alias doc='~/demo/base/doc.sh '
alias start-blog='cd ~/demo; npm run server &> /root/demo/server.log &'
alias weechat='cd ~; weechat'
